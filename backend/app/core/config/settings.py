...
class Settings(BaseSettings):
    ...
    app_name: str = "ai-safety-eval-dash"
    ...
    database_url: Optional[str] = Field(
        default="postgresql://postgres:postgres@localhost:5432/ai-safety-eval-dash",
    ...
    kafka_group_id: str = Field(default="ai-safety-eval-dash_backend", description="Kafka consumer group ID")
    ...
    pinecone_index_name: str = Field(default="ai-safety-eval-dash-memory", description="Pinecone index name")
