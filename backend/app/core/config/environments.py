...
class DevelopmentSettings(Settings):
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5432/ai-safety-eval-dash_dev"
...
class StagingSettings(Settings):
    ...
    database_url: str = "postgresql://postgres:postgres@localhost:5432/ai-safety-eval-dash_staging"
...
class ProductionSettings(Settings):
    ...
    log_level: str = "INFO"
    structured_logging: bool = True
    log_file: Optional[str] = "/var/log/ai-safety-eval-dash/app.log"
    ...
    allowed_hosts: list[str] = [
        ...
        "www.ai-safety-eval-dash.com",
        "api.ai-safety-eval-dash.com",
    ]
