"""
Agno + OpenRouter LLM client implementation for ai-safety-eval-dash.
...
class AgnoOpenRouterClient(BaseLLMClient):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.site_url = config.get("site_url", "ai-safety-eval-dash")
        self.app_name = config.get("app_name", "ai-safety-eval-dash")
